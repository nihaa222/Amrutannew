 ...
 Dinpro bold text-[48px] leading-[61.82px]"
        ...
        <div className="mt-[100px]  lg:mx-[200px] mx-[20px]">
          <div className="grid gap-2 grid-cols-maxy lg:grid-cols-4">
            ...
            {/* 3 */}
            <div className=" bg-white shadow-top rounded-b-[20px] relative px-[24px] pt-[45px] pb-[40px] rounded-tl-[50px] border-[#3A643B] border-t-[8px] rounded-tr-[50px] ">
            ...
            {/* 4 */}
            <div className=" bg-white shadow-top rounded-b-[20px] relative px-[24px] pt-[48px] pb-[48px] rounded-tl-[50px] border-[#3A643B] border-t-[8px] rounded-tr-[50px] ">
      ...
      <div className="relative">
        <img className="w-full h-[500px]" src="rect.png" alt="Rectangle"></img>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-[856px] mx-auto px-4">
            <p className="text-center text-[#FFF7E2] px-8 Dinpro text-[32px] leading-[41.22px] md:leading-[64px] md:text-[64px]">
              Ready to restore harmony in your mind, body and spirit?
            </p>
            <div className="flex items-center justify-center">
              {/* <button className="w-[276px] object-contain md:object-none  h-[72px]  rounded-[16px] px-[20px] pt-[24px] pb-[21px] bg-[#3A643B] text-white mt-4">
                Book a consultation
              </button> */}
            </div>
          </div>
